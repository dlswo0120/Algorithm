...
public class LinkedListTester {
	...
	//데이터
	static class Data{
		static final int NO = 1;  //번호를 입력받는다?
		static final int NAME = 2;//이름을 입력받는다?
	...
	public static void main(String[] args) {
		...
		do {
			...
			case NEXT: //선택 노드를 다음 노드로 이동
				list.next();
				break;
				
			case PRINT_CRNT: //현재 노드를 출력
